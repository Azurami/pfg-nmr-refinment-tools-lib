...
from refinment.processing.data_reading import read_data_for_processing_bruker
...
if __name__ == '__main__':
    ...
    #
    gamma, small_delta, big_delta, right_point, left_point, spectra_full_file_name, difflist_full_file_name, output_dir_name = read_inputs(
        args)
    try:
        full_spectra, gradients = read_data_for_processing_bruker(difflist_full_file_name, spectra_full_file_name)
    except:
        print('Error: Wrong input files format or there are missing files')
    else:
        ...
        if pass_mark:
            ...
            print("You can see the full results in 'Result' folder and figures in 'figures' folder ")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~The END!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        else:
